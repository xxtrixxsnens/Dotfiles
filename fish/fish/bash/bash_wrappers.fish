...
function tee_clipboard
  bash -c 'source "/home/snens/.bashrc.d/utilities.sh"; tee_clipboard "$@"' -- $argv
end

function generate_fish_wrappers
  bash -c 'source "/home/snens/.bashrc.d/generate_fish_wrappers.sh"; generate_fish_wrappers "$@"' -- $argv
end
