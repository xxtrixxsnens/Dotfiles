...
### Import own python scripts
# Custom bangs
from bangs.searchengines  import load_and_extract_bangs

c.tabs.title.format = "{audio}{current_title}"
c.fonts.web.size.default = 20

# Get the bangs
bangs = '/home/snens/.config/qutebrowser/bangs/bangs.json' # TODO RELATIVE
bang_dict = load_and_extract_bangs(bangs)

c.url.searchengines = bang_dict
